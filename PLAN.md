...
| Connection string default | `Encrypt=false;TrustServerCertificate=true`                             | Matches my environment ("encrypt optional, always trust cert"). Confirmed working against `dev-sql-01`. Expose `strict` / `no_tls` as options later if ever needed.                                                        |
